...
+ (void)setToastBackgroundColor:(UIColor *)backgroundColor textColor:(UIColor *)textColor
{
      ...
      tapCallback:(void(^)(void))tapCallback
{
    ...
    [UIView animateWithDuration:CSToastFadeDuration
                     ...
                     animations:^{
                         ...
                         if(duration != TOAST_DURATION_INDEFINITE) {
...
- (void)makeToastActivity:(id)position {
    ...
    activityView.backgroundColor = [_backgroundColor colorWithAlphaComponent:CSToastOpacity];
    activityView.alpha = 0.0;
    activityView.autoresizingMask = (UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin);
    activityView.layer.cornerRadius = CSToastCornerRadius;
    
    if (CSToastDisplayShadow) {
        activityView.layer.shadowColor = _backgroundColor.CGColor;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (CSToastDisplayShadow) {
        wrapperView.layer.shadowColor = _backgroundColor.CGColor;
        wrapperView.layer.shadowOpacity = CSToastShadowOpacity;
        wrapperView.layer.shadowRadius = CSToastShadowRadius;
        wrapperView.layer.shadowOffset = CSToastShadowOffset;
    }
    
    wrapperView.backgroundColor = [_backgroundColor colorWithAlphaComponent:CSToastOpacity];
    ...
    if (message != nil) {
        ...
        messageLabel.textColor =  _textColor;
